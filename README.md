...
```
week{NN}-session{NN}.md
```

- `week{NN}` — week number (01–12), zero-padded
- `session{NN}` — session within that week (01–03), ordered by date
- Dates, titles, and topics live in this README and in each file's heading
